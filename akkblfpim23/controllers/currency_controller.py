...
"""
    akkblfpim23.controllers.currency_controller
...
class CurrencyController(BaseController):
    ...
    def get_currency_2_x_only(self):
        """Does a GET request to /rest/v1/currencies/USD.
        ...
        _query_builder += '/rest/v1/currencies/USD'
    ...
    def get_currencies_2_x_only(self):
        """Does a GET request to /rest/v1/currencies.
        ...
        # Prepare query URL
        _query_builder = Configuration.get_base_uri()
        _query_builder += '/rest/v1/currencies'
        _query_url = APIHelper.clean_url(_query_builder)
